...
# Transfer NRK or TL20 using Bridge on Fuseswap
...
Once the transaction is confirmed on chain, the **“Transfer”** can be clicked and transaction has to be approved. Once this second transaction is confirmed onchain the NRK balance in the same address on Nordek network will have the updated balance of NRK which can be checked through [www.nordekscan.com](http://www.nordekscan.com/). 
