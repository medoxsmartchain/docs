...
[Any entity that is holding the MEDOX token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of MEDOX token (MDC).
...
[You can delegate you MEDOX token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their MEDOX token to a validator to earn rewards through the validator.
