...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on MEDOX after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “MEDOX network” and perform the transactions on MEDOX network through your Ledger device.

Note: To learn how to add MEDOX RPC follow [this link.](https://docs.mdcscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
