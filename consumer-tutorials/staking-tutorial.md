---
description: This tutorial will explain how to delegate/stake/unstake your MDC.
---

# Staking tutorial

Note: You can only stake MDC which is on MEDOX network. Please make sure you have changed into MEDOX network in Metamask while doing any transactions on staking UI. 

How to Stake MEDOX:

**Step 1:**

Navigate to staking.mdcscan.com and login to your wallet through metamask. Make sure you are on MEDOX network. If you are not please follow the instructions [**here**](https://docs.mdcscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of MDC you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
