---
description: This tutorial will explain how to delegate/stake/unstake your NRK.
---

# Staking tutorial

Note: You can only stake NRK which is on Nordek network. Please make sure you have changed into Nordek network in Metamask while doing any transactions on staking UI. 

How to Stake Nordek:

**Step 1:**

Navigate to staking.nordekscan.com and login to your wallet through metamask. Make sure you are on Nordek network. If you are not please follow the instructions [**here**](https://docs.nordekscan.com/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
You will also see the APY on staking when you enter the amount of NRK you want to stake. You can see the staked amount right next to the validator name to whom you have delegated you stake to. 
